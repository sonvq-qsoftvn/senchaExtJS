...
folder are mapped to the application's root namespace, 'ThemeSpotifextApp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ThemeSpotifextApp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ThemeSpotifextApp' in the same way
as `"ThemeSpotifextApp/sass/src"`.
